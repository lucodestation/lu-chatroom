    ...
    <el-container class="main">
      ...
      <el-main style="height: 100%">
        ...
        <Chat
          ...
          @submitMessageEvent="submitMessageEvent"
        />

        <!-- 登录界面 -->
        <Login v-else :loginStart="loginStart" @loginEvent="loginEvent" />
      </el-main>
    </el-container>
    ...
    <el-dialog title="" :visible.sync="dialogVisible" width="80%">
      <div>
        ...
        <ul>
          ...
          <li>
            登录后即可开始聊天。输入聊天内容后点击 <strong>发送</strong> 或按
            <strong><kbd>Ctrl</kbd> + <kbd>Enter</kbd></strong> 即可发送消息。
          </li>
        ...
        <ul>
          ...
          <li>
            您登录的用户会在浏览器刷新后自动下线，并且所有聊天记录不会被保存。
          </li>
        </ul>
      </div>
